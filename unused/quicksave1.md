// 7-24-26 3:04 pm -- right before moving to multifile standard
...
private:
	...
	wstring m_appName = L"pctopc-fast-host";
	UINT m_fps = 144;
	...
	void Loop() {
		...
		m_windowManager->MessageLoopRun(

			[this]() { m_graphicsEngine->RunUILoopAndPresent(); },
			WM_RENDER_UI_MESSAGE
